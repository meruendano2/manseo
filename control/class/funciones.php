...
class Funciones{
		...
		$this->campos=array();
				...
				/// ******** para mostra campo
function mostrarCampoInput($tipo,$label,$id,$valor,$requerido,$error,$min){
if($tipo!='hidden'){
	$dato="<div class='form-group'>";
		if($label!='') $dato.=" <label for='".$id."' >".$label.":</label>";
		$dato.="<input class='form-control input-sm' type='".$tipo."' name='".$id."' id='".$id."'  value='".$valor."'  min='".$min."'  ".$requerido." data-error='".$error."'  placeholder='".$label."' />";
